    ...
    <div class="card-body">
      ...
      <p class="card-text">
        ...
        ?>
          <li class="list-group-item">
            <strong>Product:</strong> <?php echo $sale['product_name']; ?> | 
            <strong>Date:</strong> <?php echo $sale['sale_date']; ?> | 
            <strong>Price:</strong> <?php echo $sale['saleprice']; ?>
          </li>
        <?php
          }
        ?>
      ...
      <p class="card-text">
        <small class="text-body-secondary">
          <strong>Phone:</strong> <?php echo $customer['cust_phone']; ?> | 
          <strong>Email:</strong> <?php echo $customer['cust_email']; ?>
        </small>
      </p>
