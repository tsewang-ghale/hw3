    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
          <div class="mb-3">
            <label for="cust_firstname_<?php echo $customer['cust_id']; ?>" class="form-label">First Name</label>
          ...
          <div class="mb-3">
            <label for="cust_lastname_<?php echo $customer['cust_id']; ?>" class="form-label">Last Name</label>
          ...
          <div class="mb-3">
            <label for="cust_address_<?php echo $customer['cust_id']; ?>" class="form-label">Address</label>
            <input type="text" class="form-control" id="cust_address_<?php echo $customer['cust_id']; ?>" name="cust_address" value="<?php echo $customer['cust_address']; ?>">
          </div>
          <div class="mb-3">
            <label for="cust_phone_<?php echo $customer['cust_id']; ?>" class="form-label">Phone</label>
            <input type="text" class="form-control" id="cust_phone_<?php echo $customer['cust_id']; ?>" name="cust_phone" value="<?php echo $customer['cust_phone']; ?>">
          </div>
          <div class="mb-3">
