...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newformCustomerWithPurchaseModal">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="newformCustomerWithPurchaseModalLabel"> New Customers with Purchase</h1>
