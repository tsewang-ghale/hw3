  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editSaleItemModalLabel<?php echo $saleitem['Saleitem_id']; ?>">Edit Sale Item</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form method="post" action="">
          <div class="mb-3">
            <label for="product_id_<?php echo $saleitem['Saleitem_id']; ?>" class="form-label">Product ID</label>
            <input type="number" class="form-control" id="product_id_<?php echo $saleitem['Saleitem_id']; ?>" name="product_id" value="<?php echo $saleitem['product_id']; ?>">
          </div>
          <div class="mb-3">
            <label for="sale_id_<?php echo $saleitem['Saleitem_id']; ?>" class="form-label">Sale ID</label>
            <input type="number" class="form-control" id="sale_id_<?php echo $saleitem['Saleitem_id']; ?>" name="sale_id" value="<?php echo $saleitem['sale_id']; ?>">
          </div>
          <div class="mb-3">
