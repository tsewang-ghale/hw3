  ...
  switch ($_POST ['actionType']) {
    case "Add": 
     if (insertCustomersPurchase($_POST['Cust_id'], $_POST['cust_firstname'], $_POST['cust_lastname'], $_POST['product_name'], $_POST['sale_date'], $_POST['tax'], $_POST['shipping'], $_POST['quantity'], $_POST['saleprice'])) {
      ...
      break; 
    case "Edit": 
      if (UpdateCustomersPurchase($_POST['sid'], $_POST['custId'],$_POST['cust_firstname'], $_POST['cust_lastname'], $_POST['product_name'], $_POST['tax'], $_POST['shipping'], $_POST['quantity'], $_POST['saleprice'])) {
