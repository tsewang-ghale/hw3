  ...
  switch ($_POST ['actionType']) {
    case "Add": 
     if (insertCustomersPurchase($_POST['cust_id'], $_POST['cust_firstname'], $_POST['cust_lastname'], $_POST['product_name'], $_POST['sale_date'], $_POST['tax'], $_POST['shipping'], $_POST['quantity'], $_POST['saleprice'])) {
      ...
      break; 
    case "Edit": 
      if (UpdateCustomersPurchase($_POST['sale_id'], $_POST['cust_id'],$_POST['cust_firstname'], $_POST['cust_lastname'], $_POST['product_name'], $_POST['tax'], $_POST['shipping'], $_POST['quantity'], $_POST['saleprice'])) {
      ...
      break; 
    case "Delete":
      if (deleteCustomersPurchase($_POST['sale_id'])) {
