<div class="row">
  ...
  <div class="col-auto">
    <?php include "view-saleitems-newform.php"; ?>
  </div>
</div>
    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td>
            <form method="post" action="delete-saleitem.php">
              <input type="hidden" name="Saleitem_id" value="<?php echo htmlspecialchars($saleitem['Saleitem_id']); ?>">
