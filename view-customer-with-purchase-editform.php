<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editCustomerWithPurchaseModal<?php echo $product['product_id']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="editCustomerWithPurchaseModal<?php echo $product['product_id']; ?>" tabindex="-1" aria-labelledby="editCustomerWithPurchaseModalLabel<?php echo $product['product_id']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editCustomerWithPurchaseModalLabel<?php echo $product['product_id']; ?>">Edit Product</h1>
